        ...
        <form method="POST" action="{{ route('expenses.update', $expense->id) }}" class="space-y-6">
            ...
            <div class="form-group">
                ...
                <div class="select-wrapper">
                    <select id="category_id" class="form-input @error('category_id') is-invalid @enderror" name="category_id" required>
            ...
            <div class="form-group">
                ...
                <div class="select-wrapper">
                    <select id="type" class="form-input @error('type') is-invalid @enderror" name="type" required>
